...
$pid=$_POST['pid'];
$result = mysqli_query($con,"SELECT * FROM $table2 WHERE pid='$pid' ");
...
foreach($_POST as $key => $value) {
    ...
    //$sql="UPDATE WHERE pid='$pid' $table2 ($key) VALUES ('$entry')";
...
$sql="UPDATE $table2 SET updated='$unix_date' WHERE pid='$pid'";
mysqli_query($con,$sql);
//if (!mysqli_query($con,$sql)) {
//  die('Error: ' . mysqli_error($con));
//}
